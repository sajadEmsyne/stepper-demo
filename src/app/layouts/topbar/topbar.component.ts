import { Component, OnInit, EventEmitter, Output, Inject, ViewChild, TemplateRef, HostListener, ElementRef } from '@angular/core';
...
export class TopbarComponent implements OnInit {
  ...
  @ViewChild('openDropdown', { static: false }) openDropdown!: ElementRef;
  notifyId: any;
  ...
  ngOnInit(): void {
    ...
    /**For setting side bar menu collapsed */
    ...
    this.formattedDate = formatDate(new Date(), 'dd/MMM/yy', 'en-US');
    let userDataObj: any = sessionStorage.getItem('currentUser');
    this.userDetails = JSON.parse(userDataObj)
    this.userName = 'Jane Doe'
  }
  /**Hide notification dropdown on outside click */
  @HostListener('document:click', ['$event'])
  onClickOutside(event: MouseEvent) {
    if (this.dropdownMenu && !this.dropdownMenu.nativeElement.contains(event.target) && (this.openDropdown && !this.openDropdown.nativeElement.contains(event.target))) {
      this.closeDropdown();
    }
  }
  ...
  /***return back the fullscreen icon when i press the esc key**/
  @HostListener('document:fullscreenchange', [])
  onFullScreenChange() {
    // Sync fullScreen status with the actual fullscreen state
    this.fullScreen = !document.fullscreenElement;
  }

  navigationUrl() {
    this.router.navigateByUrl('/app/customer/create');
  }
  /**
  ...
  fullscreen() {
    ...
    if (!document.fullscreenElement && !this.element.mozFullScreenElement && !this.element.webkitFullscreenElement) {
      ...
      if (this.element.requestFullscreen) {
        console.log("this.fullScreenIF", this.fullScreen);
      ...
      console.log("this.fullScreenelsF", this.fullScreen);
