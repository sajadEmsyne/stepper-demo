...
import { DATA_PRELOADER, LAYOUT, LAYOUT_MODE, LAYOUT_POSITION, LAYOUT_WIDTH, SIDEBAR_COLOR, SIDEBAR_IMAGE, SIDEBAR_SIZE, SIDEBAR_VIEW, TOPBAR } from '../layout.model';
...
export class VerticalComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    const savedImage = localStorage.getItem('sideBarImage');
    if (savedImage) {
      document.documentElement.setAttribute('data-sidebar-image', savedImage);
    }
