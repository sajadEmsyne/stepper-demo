			...
			case isLayoutAttributes:
				...
				switch (isLayoutAttributes["data-sidebar"]) {
					...
					case "gradient-4":
						...
						break;
					case "gradient-5":
						getElementUsingTagname("data-sidebar", "gradient-5");
						sessionStorage.setItem("data-sidebar", "gradient-5");
						document.documentElement.setAttribute("data-sidebar", "gradient-5");
						break;
					default:
						if (sessionStorage.getItem("data-sidebar") && sessionStorage.getItem("data-sidebar") == "light") {
							...
							getElementUsingTagname("data-sidebar", "gradient-4");
							document.documentElement.setAttribute("data-sidebar", "gradient-4");
						} else if (sessionStorage.getItem("data-sidebar") == "gradient-5") {
							sessionStorage.setItem("data-sidebar", "gradient-5");
							getElementUsingTagname("data-sidebar", "gradient-5");
							document.documentElement.setAttribute("data-sidebar", "gradient-5");
						}
				...
				switch (isLayoutAttributes["data-body-image"]) {
					...
					case "img-3":
						...
						break;
					case "img-5":
						getElementUsingTagname("data-body-image", "img-5");
						sessionStorage.setItem("data-body-image", "img-5");
						document.documentElement.setAttribute("data-body-image", "img-5");
						break;
					case "none":
					...
					default:
						if (sessionStorage.getItem("data-body-image") && sessionStorage.getItem("data-body-image") == "img-1") {
							...
							getElementUsingTagname("data-body-image", "img-3");
							document.documentElement.setAttribute("data-body-image", "img-3");
						} else if (sessionStorage.getItem("data-body-image") == "img-5") {
							sessionStorage.setItem("data-body-image", "img-5");
							getElementUsingTagname("data-body-image", "img-5");
							document.documentElement.setAttribute("data-body-image", "img-5");
